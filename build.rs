...
fn main() {
  ...
  let cudnn_bindings = bindgen::Builder::default()
    ...
    .whitelist_function("cudnnGetConvolutionForwardAlgorithmWorkspaceSize")
    ...
    .whitelist_function("cudnnGetConvolutionBackwardFilterAlgorithmWorkspaceSize")
    ...
    .whitelist_function("cudnnGetConvolutionBackwardDataAlgorithmWorkspaceSize")
    .whitelist_function("cudnnConvolutionBackwardFilter")
